                ...
                <div className="card-body">
                    ...
                    <form className="w-50" onSubmit={ event =>{
                        ...
                        <input type="text" 
                               name="product"
                               value={ productValue}
                               placeholder="Producto" className="form-control m-3" onChange={event => onProductChange(event) }/>
                        ...
                        <input type="text" 
                               name="quantity"
                               value={quantityValue}
                               placeholder="Cantidad" className="form-control m-3" onChange={event => onQuantityChange(event)}/>
                        <button type ="submit" 
